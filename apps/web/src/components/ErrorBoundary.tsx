  ...
  render(): ReactNode {
    ...
    return (
      <div className="flex h-screen items-center justify-center bg-slate-950 p-6 text-slate-100">
        <div className="operator-popover max-w-2xl border-red-400/30 bg-red-950/40 p-5">
          ...
          <pre className="mt-4 max-h-56 overflow-auto border border-red-400/15 bg-black/40 p-3 text-xs text-red-100">
