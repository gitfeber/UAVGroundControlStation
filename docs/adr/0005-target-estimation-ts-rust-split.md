...
**Decision:** Reject all-Rust (hurts TS unit tests and web iteration) and all-TS (large projected DEM GeoTIFFs do not belong in browser/Node dev). Desktop remains the only production path for real terrain data, consistent with ADR 0001.
